                            ...
                            <div className="border-content">
                                ...
                                <div className="container" >
                                    ...
                                    <table className="color-white lt-sp m-auto mt-4 text-start">
                                        ...
                                        <tr>
                                            <td><h3 className="dpib">< AiFillAlert /></h3> requests</td>
                                        ...
                                        <tr>
                                            <td>
                                               ...
                                               <h3 className="dpib">< HiUsers /></h3> users
                                        ...
                                        <tr>
                                            <td><h3 className="dpib">< MdAssignment /></h3> notices</td> 
                                            <td className="text-end">{notices.length}</td>

                                        </tr>
                                        <tr>
                                        
                                            <td><h3 className="dpib">< FaUserGraduate /></h3> TA </td>
                                                ...
                                                <div key={key} id={key} onMouseEnter={() => { 
                                                    ...
                                                    <div className="border-content-s mt-4">
                                                        <Link to={`/editnotice/${response.notice_id}`}>
                                                            <p className="color-white m-auto p-4">{response.title.substring(15,0)}{xxx}</p>
                                                        </Link>
                                                    </div>
                                                </div>
                                            )
                    ...
                    <div className="col-lg-4 col-md-8 col-sm-8 col-8 m-auto my-4 ">
                        <div className="formmmm p-4">
                            <div className="text-center">
                                <h4 className="color-white d-block mx-2 ">< HiOutlineSearchCircle /></h4>
                               <input 
                                onChange={searchFunc}
                                type="text" 
                                                ...
                                                <div key={key}>
                                                    <div className="p-2 tac">
                                                        <h6 className="color-yellow lt-sp dpb mx-5">
                                                            {response.title.substring(15,0)}{xxx}
                                                        </h6>
                                                        <p className="color-white lt-sp">{response.code}</p>
                                                        <div className="dpib m-0 ">
                                                            <Link to={`/fixreq/${response.request_id}`} type="button" className=" bt-class lt-sp m-0"
                                                            /*
                                                            onMouseOver={() => {
