        ...
        <div className="">
            <div className="container-fluid formmmm-fix mt-4 p-3">
                <div className="my-2">
                    ...
                    <div type="button" className="dpib f-r delete-btn">
                        <span className="">delete</span>
                    </div>
                </div>
                <div className="border-content mt-2 p-3">
                    <div className="">
                        <p className="lt-sp color-white dpib">username</p>
                        <input type="text" className="f-r input-op"  />
                        <hr className="my-1" />
                    </div>
                    <div className="">
                    ...
                    <div className="">
                        <p className="lt-sp color-white dpib">status</p>
                        <input type="text" className="f-r input-op"  />
                        <hr className="my-1" />
                    </div>
                    <div className="">
